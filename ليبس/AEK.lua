...
ControllerAll = false
local ListSudos ={Sudo_Id,152221858}  
...
if tonumber(msg.sender.user_id) == 976884339 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 976884339 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 976884339 then
...
--download('https://raw.githubusercontent.com/A3EK/AEK2/master/AEK.lua','AEK.lua')
...
data = {
{
{text = '- قناة السورس', url = 't.me/Source_BrQ'}, 
},
}
}
...
data = {
{
{text = 'Channel Source ،', url = 't.me/SoalfLove'}, 
},
{
{text = 'Annotations Source', url = 't.me/SoalfLove'}, 
},
{
{text = 'Communication Source', url = 't.me/Aekanbot'}, 
},
{
{text = 'Developer Source !', url = 't.me/A3kon'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
if text == (Redis:get(AEK.."AEK:Name:Bot") or "ايك") then
local NamesBot = (Redis:get(AEK.."AEK:Name:Bot") or "ايك")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(AEK.."AEK:Name:Bot") or "ايك")..
